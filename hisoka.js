...
hisoka.sendMessage(m.chat, buttonsNekoMessages,{ quoted:m }).catch(err => { return('Error!')})
}
break
...
let buttonsTsMessages = {
 ...
 hisoka.sendMessage(m.chat, buttonsTsMessages,{ quoted:m }).catch(err => { return('Error!')})
}
break
...
hisoka.sendMessage(m.chat, { text: `p`, templateButtons: [
...
case 'bugverify':{
if (!q) return m.reply("Nomornya mana")
